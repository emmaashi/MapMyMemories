      ...
      <div className="w-full max-w-2xl"> 
        ...
        <Card className="bg-white shadow-sm border border-gray-200">
          <CardHeader className="text-center pb-6">
            ...
            <p className="text-gray-600 mt-2">Sign in to access your travel memories</p>
          </CardHeader>
            ...
            <form onSubmit={handleLogin} className="space-y-6 w-full">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    required
                    className="pl-10 h-12 border-gray-300 focus:border-gray-400 focus:ring-0 rounded-lg w-full min-w-0"
                  />
                </div>
              </div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    required
                    className="pl-10 pr-10 h-12 border-gray-300 focus:border-gray-400 focus:ring-0 rounded-lg w-full min-w-0"
                  />
                  <button
                    type="button"
